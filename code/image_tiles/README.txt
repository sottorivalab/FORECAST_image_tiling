...
If you wish to instead use a different version of OpenCV installed on your system, please update the "openCVPath" variable in process_images.sh to point to the folder where the relevant .so/.dll files are located. Also ensure that the associated JAR file is included on your CLASSPATH.
